...
object CompositionMapAndFilter extends App {
  ...
  val logger = LogManager.getLogger(CompositionMapAndFilter)
...
object CompositionConcatAndFlatten extends App {
  ...
  val logger = LogManager.getLogger(CompositionConcatAndFlatten)
  def log(s: String) = logger.info(s)
...
object CompositionRetry extends App {
  ...
  val logger = LogManager.getLogger(CompositionRetry)
  def log(s: String) = logger.info(s)
...
object CompositionScan extends App {
  ...
  val logger = LogManager.getLogger(CompositionScan)
  def log(s: String) = logger.info(s)
...
object CompositionReduce extends App {
  ...
  val logger = LogManager.getLogger(CompositionReduce)
  def log(s: String) = logger.info(s)
...
object CompositionErrors extends App {
  ...
  val logger = LogManager.getLogger(CompositionErrors)
  def log(s: String) = logger.info(s)
