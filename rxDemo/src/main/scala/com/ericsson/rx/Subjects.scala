...
object SubjectsOS extends App {
  ...
  val logger = LogManager.getLogger(SubjectsOS)
...
object SubjectsOSLog extends App {
  ...
  val logger = LogManager.getLogger(SubjectsOSLog)
  def log(s: String) = logger.info(s)
  ...
  val loadedModules = List(
    TimeModule.systemClock,
    FileSystemModule.fileModifications).map(_.subscribe(RxOS.messageBus))
...
object SubjectsOSRegistry extends App {
  ...
  val logger = LogManager.getLogger(SubjectsOSRegistry)
  def log(s: String) = logger.info(s)
...
object SubjectsAsync extends App {
  ...
  val logger = LogManager.getLogger(SubjectsAsync)
  def log(s: String) = logger.info(s)
